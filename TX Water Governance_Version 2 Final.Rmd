...
V(g1_agriculture)[which(V(g1_agriculture)$type=="Academic")]$color<-"#97c2fc"
V(g1_agriculture)[which(V(g1_agriculture)$type=="Public")]$color<-"#eb7df4"
...
edges <- replace(edges, edges == "gray", NA)
...
E(g1_environment)[E(g1_environment)$type=="Advocacy/Policy Preference"]$color <-"#00008b" #40% of ENV ties
...
E(g1_groundwater)[E(g1_groundwater)$type=="Advocacy/Policy Preference"]$color <-"#00008b" #40% of ENV ties
E(g1_groundwater)[E(g1_groundwater)$type=="Authority to set rules"]$color <-"#990000"
...
E(g1_municipal)[E(g1_municipal)$type=="Advocacy/Policy Preference"]$color <-"#00008b" #40% of ENV ties
...
E(g1_rural)[E(g1_rural)$type=="Contract"]$color <-"#FFA807" #13% of Rural ties
...
saveRDS(g1, file="texaswg/data/g12.rds")
saveRDS(g1_agriculture, file="texaswg/data/g1_agriculture2.rds")
saveRDS(g1_environment, file="texaswg/data/g1_environment2.rds")
saveRDS(g1_flooding, file="texaswg/data/g1_flooding2.rds")
saveRDS(g1_groundwater, file="texaswg/data/g1_groundwater2.rds")
saveRDS(g1_innovation, file="texaswg/data/g1_innovation2.rds")
saveRDS(g1_municipal, file="texaswg/data/g1_municipal2.rds")
saveRDS(g1_oilandgas, file="texaswg/data/g1_oilandgas2.rds")
saveRDS(g1_rural, file="texaswg/data/g1_rural2.rds")
