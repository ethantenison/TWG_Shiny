...
#vissaveRDS(viz, "media/simplied_all_network.html", selfcontained = TRUE, background = "white")
...
saveRDS(g1, file="texaswg/data/g1.rds")
saveRDS(g1_agriculture, file="texaswg/data/g1_agriculture.rds")
saveRDS(g1_environment, file="texaswg/data/g1_environment.rds")
saveRDS(g1_flooding, file="texaswg/data/g1_flooding.rds")
saveRDS(g1_groundwater, file="texaswg/data/g1_groundwater.rds")
saveRDS(g1_innovation, file="texaswg/data/g1_innovation.rds")
saveRDS(g1_municipal, file="texaswg/data/g1_municipal.rds")
saveRDS(g1_oilandgas, file="texaswg/data/g1_oilandgas.rds")
saveRDS(g1_rural, file="texaswg/data/g1_rural.rds")
```
